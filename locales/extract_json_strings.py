#!/usr/bin/env python3
"Extract translatable strings from the .json files in libraries/json."
...
#    raw_dir = "data/raw"
    json_dir = "libraries/json"
    mods_dir = "libraries/mods"
    to_dir = "locales/json"
elif os.path.exists("../libraries"):
#    raw_dir = "../data/raw"
    json_dir = "../libraries/json"
    mods_dir = "../libraries/mods"
    to_dir = "../locales/json"
else:
    print("Error: Couldn't find the 'libraries' subdirectory.")
    exit(1)
